    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className={`${cardBgClass} rounded-lg p-6 md:col-span-2 lg:col-span-2 flex items-center justify-center`}>
            <div className="text-center">
              <img src="/garment-image.jpg" alt="Garment" className="w-24 h-24 object-contain mx-auto mb-2" />
